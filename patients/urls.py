...
from .views import PatientViewSet, PatientDocumentViewSet, ResponseLettersViewSet, ContractApproveViewSet, MeProfileView
...
urlpatterns = [
    ...
    # Qo‘shimcha pathlar (faqat bitta 'patients/'!)
