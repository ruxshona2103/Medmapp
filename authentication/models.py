...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, phone_number, password=None, **extra_fields):
        ...
        return self._create_user(phone_number, password, role='superadmin', **extra_fields)
...
class OTP(models.Model):
    user = models.ForeignKey("authentication.CustomUser", on_delete=models.CASCADE, related_name="otps", null=True, blank=True)
